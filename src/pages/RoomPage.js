    ...
    <main>
      ...
      <Wrapper className="page section section-center">
        ...
        <article className="onebytwo">
          <Fade left>
            <p>
              Tiếp đến đó là phong cách Organic: Luôn hướng tới sự tổng hòa về
              màu sắc và chất liệu trong không gian sống, tạo đượcc cảm giác
              thân thiện với thiên nhiên, con người. Với phong cách thiết kế nội
              thất này giúp mang tới không gian sống độc đáo, phá cách hơn nhưng
              cũng giữ lại được sự gần gũi và chân phương cần thiết. Không gian
              sống được thiết kế trong phong cách này những món đồ nội thất được
              thiết kế, bài trí với hình dạng tự do, phóng khoáng với những
              đường cong mềm mại. Chúng đều được lấy cảm hứng từ thiên nhiên.
              <br></br>
        ...
        <Fade bottom>
          ...
          <p>
            ...
            mang tới không gian sống lý tưởng như vậy trong căn hộ của mình bằng
            phong cách nội thất như: pop art, tropical, expressionism,… Phong
            cách nội thất Pop Art: sử dụng những màu sắc, hình khối và vật liệu
            đơn giản nhưng lại được cách điệu giúp mang tới tính thẩm mỹ và công
            năng sử dụng cao. Phong cách thiết kế Pop Art có đặc diểm rất dễ
            nhận biết bởi việc hình ảnh trang trí, gam màu được sử dụng một cách
            táo bạo, màu sắc rực rỡ, có sự tương phản mạnh mẽ. Những gam màu sử
            dụng trong phong cách thiết kế nội thất này chủ yếu là màu đỏ, vàng,
            xanh dương. Pop Art còn thể hiện tính đa chiều và thể hiện được “
            tính cách” của không gian sống đó là sự quyễn rũ, lãng mạn, mạnh mẽ
            và có một chút lòe loẹt được thể hiện qua sự chuyển động của hình
            khối, ánh sáng. Với trường phái cổ điển ưu tiên sự sang trọng thì
            với phong cách thiết kế Pop Art đúng như cái tên của nó: Nghệ thuật
            và đầy màu sắc. Với không gian sống được thiết kế theo phong cách
            này bạn sẽ được tận hưởng một không gian sống đầy nghệ thuật.
          </p>
        </Fade>
        ...
        <Fade bottom>
          ...
          <p>
            ...
            nhìn sâu sắc và yêu thích sự tối giản. Bởi vậy, sự lựa chọn phù hợp
            nhất dành cho những người có tính cách này là phong cách Bắc Âu,
            phong cách tối giản (Minimalism)…
            <br></br>
            Phong cách thiết kế nội thất tối giản (Minimalism) giảm thiểu đến
            tối đa những chi tiết trang trí trong không gian, những đường nét và
            kết cấu được ẩn dấu bên dưới, đi ngược lại với phong cách thiết kế
            truyền thống về những chi tiết phức tạp và phong phú.
            <br></br>
            Phong cách này hướng đến sự loại bỏ những chi tiết thừa, nhằm mang
            tới khoảng không gian hoàn hảo. Đặc điểm của phong cách thiết kế này
            là sử dụng những đường nét thiết kế đơn giản, kết hợp với sự tính
            toán của các mặt phẳng giúp mang tới không gian có tổng thể hài hòa,
            đẹp đẽ và thoáng đãng. Hạn chế sử dụng những chi tiết hoặc vật dụng
            trang trí. Tuy được thiết kế tối giản nhưng vẫn phải đáp ứng được
            yếu tố về thẩm mỹ, sự tiện nghi trong quá trình sử dụng. Màu sắc
            cũng hạn chế sử dụng không quá 3 màu trong 1 không gian. Tường nhà
            thường sử dụng tone màu trung tính hoặc màu trắng để chuyển chú ý
            của người nhìn tới tone màu tạo điểm nhấn. óm lại, thiết kế nội thất
            theo phong cách tối giản là sử dụng những cái gì cần thiết nhất thay
            thế cho những cái cần thiết. Phong cách thiết kế tối giản nhưng
            không gian sống mang lại thì không tối giản chút nào, rất có chiều
            sâu. Do đó đây là phong cách thiết kế nội thất phù hợp nhất dành cho
            những người có tính cách hướng nội.
          </p>
        </Fade>
